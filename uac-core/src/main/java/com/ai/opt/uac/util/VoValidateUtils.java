...
public final class VoValidateUtils {
	 ...
	 */
	public static void validateInsertTenant(TenantInfoRequest tenantInfoRequest) throws BusinessException {
		...
		if(StringUtil.isBlank(tenantInfoRequest.getIndustryCode())){
			throw new BusinessException(AccountExceptCode.ErrorCode.PARAM_NULL_ERROR, "企业类型（industryCode）不能为空");
		}
	 ...
	 * @throws BusinessException
	 */
	public static void validateQueryAccountBaseInfo(AccountQueryRequest accountQueryRequest) throws BusinessException {
	 ...
	 * @throws BusinessException
	 */
	public static void validateUpdateAccountInfo(AccountBaseModifyRequest accountModifyRequest) throws BusinessException {
	 ...
	 * @throws BusinessException
	 */
	public static void validateSetAccountTenant(AccountTenantModifyRequest accountModifyRequest) throws BusinessException {
		if(accountModifyRequest == null){
			throw new BusinessException(AccountExceptCode.ErrorCode.PARAM_NULL_ERROR, "参数对象为空");
		}
		if(accountModifyRequest.getAccountId() == null){
	 ...
	 * @throws BusinessException
	 */
	public static void validateSetAccountEmail(AccountEmailRequest emailModifyRequest) throws BusinessException {
	 ...
	 * @throws BusinessException
	 */
	public static void validateSetAccountPwd(AccountPasswordRequest passwordModifyRequest) throws BusinessException {
		...
		if(StringUtil.isBlank(passwordModifyRequest.getPassword())){
			throw new BusinessException(AccountExceptCode.ErrorCode.PARAM_NULL_ERROR, "密码（password）不能为空");
		}
	}
	 ...
	 * @throws BusinessException
	 */
	public static void validateSetPhoneTenant(AccountPhoneRequest phoneModifyRequest) throws BusinessException {
		...
		if(StringUtil.isBlank(phoneModifyRequest.getPhone())){
			throw new BusinessException(AccountExceptCode.ErrorCode.PARAM_NULL_ERROR, "电话（phone）不能为空");
		}
	}
}
